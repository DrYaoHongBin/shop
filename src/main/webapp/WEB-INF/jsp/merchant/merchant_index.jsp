        ...
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="${pageContext.request.contextPath}/resources/merchant/general.html">General</a></li>
                        <li><a class="" href="${pageContext.request.contextPath}/resources/merchant/buttons.html">Buttons</a></li>
                        <li><a class="" href="${pageContext.request.contextPath}/resources/merchant/widget.html">Widget</a></li>
                        <li><a class="" href="${pageContext.request.contextPath}/resources/merchant/slider.html">Slider</a></li>
                        <li><a class="" href="${pageContext.request.contextPath}/resources/merchant/font_awesome.html">Font Awesome</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <div class="album">
                                                    <a href="#">
                                                        <img alt="" src="${pageContext.request.contextPath}/resources/merchant/img/sm-img-1.jpg">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="${pageContext.request.contextPath}/resources/merchant/img/sm-img-2.jpg">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="${pageContext.request.contextPath}/resources/merchant/img/sm-img-3.jpg">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="${pageContext.request.contextPath}/resources/merchant/img/sm-img-1.jpg">
                                                    </a>
                    ...
                    <section class="panel post-wrap pro-box">
                        ...
                        <aside class="post-highlight yellow v-align">
                            <div class="panel-body text-center">
                                <div class="pro-thumb">
                                    <img src="${pageContext.request.contextPath}/resources/merchant/img/ring.jpg" alt="">
                                </div>
                            </div>
                        </aside>
                    </section>
                                ...
                                <div class="follower">
                                    <div class="panel-body">
                                        ...
                                        <div class="follow-ava">
                                            <img src="${pageContext.request.contextPath}/resources/merchant/img/follower-avatar.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
