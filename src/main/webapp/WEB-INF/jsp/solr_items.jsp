...
<body>
    ...
    <div class="containers clearfix">
            ...
            <div class="time-border-list pc-search-list clearfix">
                <ul class="clearfix" id="itemUl">
                    <c:forEach var="item" items="${solrResult.list}">
                    <li>
                ...
                <form action="${pageContext.request.contextPath}/selectItemsBySearchName" method="post" id="solrSearch">
                   <input type="hidden" name="search" value="${search}">
                   <input type="hidden" name="page" id="solrPage">
                </form>
                <div class="clearfix">
                    <div class="fr">
                           &nbsp;
                                    共<a id="pages">${solrResult.pages}</a>页&nbsp;到第 &nbsp;<input type="text" size="5" id="page">  &nbsp;页
                                    &nbsp;
                    ...
                    <div class="fr pc-search-g">
                        ...
                        <a href="#" class="current" id="pageNum">${solrResult.pageNum}</a>
    ...
    <script type="text/javascript">
        ...
        // 上一页
        var prePage = '${solrResult.prePage}';
        // 下一页
        var nextPage = '${solrResult.nextPage}';
        ...
        // 前往前一页
        function prefPage() {
           $("#solrPage").val(prePage);
           $("#solrSearch").submit();
        }

        //前往后一页
        function nextfPage() {
            $("#solrPage").val(nextPage);
            $("#solrSearch").submit();
        }
