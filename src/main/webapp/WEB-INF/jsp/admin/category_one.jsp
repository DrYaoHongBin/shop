...
<body>
                            ...
                            <table class="table table-striped table-advance table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="${pageContext.request.contextPath}/admin/admin/removeCategoryOne?categoryOneId=${categoryOne.categoryOneId}" class="btn btn-danger btn-xs" onclick="deleteCategory(this)">删除</a>
                                    </td>
                                </tr>
                                </c:forEach>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function deleteCategory(o) {
            ...
            // 阻止超链接
            $(o).attr("href", "#");
            $.dialog('confirm','提示','该类目的下级类目将一起删除，确认要删除吗？',0,function(){
